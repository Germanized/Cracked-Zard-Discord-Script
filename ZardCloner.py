...
class misc:
    ...
    def title():
        return ctypes.windll.kernel32.SetConsoleTitleW("Zard-Clone V1")
    clear()
    def load(text):
        try:
          for sex in text:
    ...
    ctypes.windll.kernel32.SetConsoleTitleW("Zard-Clone V1 - Loading")
    load("""
                         \u001b[38;5;255m         ╔═╗╔═╗╦═╗╔╦╗   ╔═╗╦  ╔═╗╔╗╔╔═╗\u001b[0m 
                         \u001b[38;5;246m         ╔═╝╠═╣╠╦╝ ║║───║  ║  ║ ║║║║║╣ \u001b[0m 
                         \u001b[38;5;240m         ╚═╝╩ ╩╩╚══╩╝   ╚═╝╩═╝╚═╝╝╚╝╚═╝\u001b[0m 
...
class Init:
    ...
    async def on_ready():
        ...
        print(f'''
                        ...
                        \u001b[38;5;244m          Prefix:\u001b[0m \u001b[1m\u001b[38;5;255m{prefix}zardc\u001b[0m 
    ...
    async def zardc(ctx): 
        ...
        zard = await client.create_guild(f'ZardClone | {ctx.guild.name}')
        await asyncio.sleep(2)
        for sex in client.guilds:
            if f'ZardClone | {ctx.guild.name}' in sex.name:
    ...
    try:
        ...
        logging.critical(f"The token you entered is invalid. ");input()
